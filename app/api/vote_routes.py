...
def create_vote():
    ...
    if prev_comment_vote != None:
        ...
        if prev_comment_vote.vote == vote:
            if vote == False and prev_comment_vote.vote == False:
                comment_score.vote_score = (comment_score.vote_score + 1)
            elif vote == True and prev_comment_vote.vote == True:
                comment_score.vote_score = (comment_score.vote_score - 1)
        ...
        if prev_anno_vote.vote == vote:
            if vote == False and prev_anno_vote.vote == False:
                annotation_score.vote_score = (annotation_score.vote_score + 1)
            elif vote == True and prev_anno_vote.vote == True:
                annotation_score.vote_score = (annotation_score.vote_score - 1)
